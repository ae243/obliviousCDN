\begin{figure}[t!]
\centering
\includegraphics[width=.3\textwidth]{publishing_content_new3}
...
\begin{figure}[t]
\centering
\includegraphics[width=.46\textwidth]{key_lookup_2}
...
\begin{figure}[t!]
\centering
\includegraphics[height=4.4cm,keepaspectratio]{request_diagram_simple2}
