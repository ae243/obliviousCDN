...
%\begin{figure}[t!]
%\centering
%\includegraphics[width=\linewidth]{ocdn_overview_updated}
...
\begin{figure}[t!]
\centering
\includegraphics[width=\linewidth]{ocdn_overview_new2}
\caption{The relationships between clients, exit proxies, CDNs, and origin servers in 
\system{}.}
\label{fig:ocd_overview}
\end{figure}
...
%While our explanation of the design of \system{} describes a series of peer proxies, but are not 
...
%
%While the proxies in \system{} are not trusted, \system{} could 
...
\subsection{Design Alternatives and Enhancements}\label{sec:enhancements}
...
% Pre-Fetched DNS Responses & {Improve performance of lookups at exit proxies.} \\
