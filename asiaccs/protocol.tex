\begin{figure}[t!]
\centering
\includegraphics[width=.75\linewidth]{publishing_content_new2}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{key_lookup}
...
request through multiple peers. We assume the client has already joined the system, which is described in more detail in Section \ref{sec:join}; at this 
