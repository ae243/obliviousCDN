...
%\{annee, feamster, jrex\}@princeton.edu}}
...
% in the abstract
\begin{abstract}
Recent episodes of governments' attempts to access user data
...
of a government (or third party) who would wish to access information about what
data is being stored on the CDN and who is accessing it. To mitigate the
resulting threats, we design and implement \system{}, a system that provides {\em
...
CDN from knowing what content is stored on the CDN or who is accessing
it. These properties of \system{} provide protections for both the client, the
content owner, and the CDN operator. We design a protocol for publishing and 
