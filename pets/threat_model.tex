...
or 
as an arbitrary number of proxies.  The adversary could 
...
deletes any data, content, or requests.  In addition, it is out of the scope of this work to prevent an attacker 
that has global monitoring knowledge; for example, \system{} will not prevent an attacker who can see all incoming and 
outgoing messages from all clients and proxies.
