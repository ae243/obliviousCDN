...
have drawn increased concern to where data belonging to or about a user (including
a user's access patterns) is located.
The location of user data  can affect which governing authorities can access
it.
