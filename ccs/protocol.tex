...
system design.}  Figure \ref{fig:publishing} shows the steps taken when publishing content.

\begin{figure}[h]
\centering
\includegraphics[width=.5\textwidth]{publishing_content}
...
\begin{figure}[h]
\centering
\includegraphics[width=.5\textwidth]{retrieving_content}
