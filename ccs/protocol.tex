...
\begin{figure*}[t]
\centering
\includegraphics[width=.9\textwidth]{publishing_content}
...
\begin{figure*}[t]
\centering
\includegraphics[width=.9\textwidth]{retrieving_content}
...
\caption{Step-by-step instructions on how to distribute keys to proxies.}
\label{fig:keys}
\end{figure}
