...
{\bf Securing CDNs.} Most prior work on securing CDNs has focused on providing content 
...
{\bf Security Issues in CDNs.} More prevalent in the literature than defense are attacks on CDNs.  Recent work 
...
{\bf Measuring and Mapping CDNs.} As CDNs have increased in popularity, and are predicted to grow even more~\cite{predict}, much research has 
