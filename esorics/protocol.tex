...
%is done to hide the original content's length, as it may be identifiable simply by its length.  
After 
...
CDNs.  %We discuss the use of multiple CDNs more in Section \ref{sec:partial} on \system{} in partial deployment.
...
\centering
\includegraphics[width=\textwidth]{publishing_content_new3}
...
\centering
\includegraphics[width=\textwidth]{key_lookup_2}
...
\centering
\includegraphics[width=\textwidth]{request_diagram_simple2}
...
\centering
\includegraphics[width=\textwidth]{implementation2}
...
%Similarly, when a client leaves the system, this information is propagated to its 
