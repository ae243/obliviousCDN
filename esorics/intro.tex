...
\system{} allows clients to request objects with identifiers that is not known to the CDN. To do so, the origin server publishes encrypted content, 
...
%%Section~\ref{sec:discussion} describes various limitations, 
