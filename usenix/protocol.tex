\begin{figure}[t!]
\centering
\includegraphics[width=.35\textwidth]{publishing_content_new2}
...
\paragraph{Deployment with Origin Servers' Full Participation.}
...
\paragraph{Deployment with Origin Servers' Partial Participation.} 
