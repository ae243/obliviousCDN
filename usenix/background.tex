...
\textbf{Content.}  CDNs, by nature, have access to all content that they distribute,
as well as 
...
to increase performance (e.g minimizing CSS, HTML, and JavaScript files, which reduces file sizes by about 20\%).  They can also inspect content to conduct HTTPS re-writes; we discuss how \system{} handles these types of optimizations  
