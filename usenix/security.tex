...
\paragraph{Chosen Plaintext Attacks.} An attacker could attempt to
...
\paragraph{Traffic Analysis Attacks.} If a CDN itself is malicious and is attempting 
...
analysis attacks~\cite{xx}; \system{} could implement one of these solutions at the exit 
proxy.
...
\paragraph{Timing Attacks.} An attacker who is passively observing traffic could potentially 
...
\paragraph{Flashcrowds.}  A flashcrowd is a large spike in traffic to a specific web
page. An attacker
